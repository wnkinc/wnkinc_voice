 ...
 *
 *   npx tsx scripts/telegram-webhook.mts set      # register <apiEndpoint>/temporal/telegram/<WEBHOOK_PATH>
...
if (action === 'set') {
  const url = `${apiEndpoint}/temporal/telegram/${secret.WEBHOOK_PATH}`;
