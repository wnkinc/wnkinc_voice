...
| `scripts/catalog.ts` | Platform catalog: every service with its trigger, rented pieces, tables, gates, markers, logging and alarms, read from cdk.out plus each source file's doc comment → `tenant-profiles/catalog.md` (gitignored) |
